...
class BootstrapTests(unittest.TestCase):
    ...
    def test_bootstrap(self):
        ...
        if os.path.isfile('./tmp/g/00.ast'):
            shutil.rmtree('./tmp/g')
        if not os.path.isdir('./tmp/g'):
            os.mkdir('./tmp/g')
    ...
    #    pprint(parser.first_sets, indent=2, depth=3)
        ...
        with open('./tmp/g/04.ebnf', 'w') as f:
        ...
        open('./tmp/g/08.ast', 'w').write(json8)
        ...
        with open('./tmp/g/09.ebnf', 'w') as f:
        ...
        with open('./tmp/g/11.ebnf', 'w') as f:
            f.write(str(g11))
        gencode11 = codegen(r11)
        with open('./tmp/g/g11.py', 'w') as f:
            f.write(gencode11)
